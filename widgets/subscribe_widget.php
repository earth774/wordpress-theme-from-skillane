            ...
            <div class="row flex-column flex-md-row flex-lg-column">
                <div class="col-md col-lg-auto">
                    ...
                    <div class="footer-social d-none d-md-block d-lg-none">
                        <a href="<?php echo get_option('wordpressthemecourse_facebook'); ?>" target="blank" class="hovicon"><i class="icon-facebook-logo"></i></a>
                        <a href="<?php echo get_option('wordpressthemecourse_twitter'); ?>" target="blank" class="hovicon"><i class="icon-twitter-logo"></i></a>
                        <a href="<?php echo get_option('wordpressthemecourse_googleplus'); ?>" target="blank" class="hovicon"><i class="icon-google-logo"></i></a>
                        <a href="<?php echo get_option('wordpressthemecourse_instagram'); ?>" target="blank" class="hovicon"><i class="icon-instagram"></i></a>
                    </div>
                </div>
                <div class="col-md">
