...
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left pr-md-4">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/content/about-01.jpg" class="w-100" alt="">
                    <div class="row mt-3">
                        <div class="col-6">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/content/about-03.jpg" class="w-100" alt="">
                        </div>
                        <div class="col-6">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/content/about-04.jpg" class="w-100" alt="">
                        </div>
                    </div>
                </div>
    ...
    <div class="section">
        <div class="container-fluid px-0">
            <div class="row no-gutters">
                ...
                <div class="col-xl-6 banner-left bg-full" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/content/banner-right-1.jpg)"></div>
            </div>
        </div>
    </div>
    <!--//section-->
    ...
    <div class="section">
        <div class="container-fluid px-0">
            <div class="banner-center bg-cover" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/content/banner-center.jpg)">
